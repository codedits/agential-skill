...
3. Framer Clean Design & Section Architecture:
   ...
   - Section-Based Architecture (100vh–140vh Desktop, Fluid Mobile): Architect webapps into distinct storytelling sections. Each section must feature one signature premium component (sticky reveals, bento grids, interactive stages). Use generous desktop heights (100vh, 120vh, 130vh, 140vh for sticky reveals), while keeping mobile fluid and responsive (`min-height: auto` or `100svh`/`100dvh`, stacked single-column layouts, generous vertical padding). Consult `references/premium-section-benchmarks.md` for visual archetypes.
